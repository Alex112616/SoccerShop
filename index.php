      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Мен</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.php">Soccer shop</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Личный кабинет <?php echo $_SESSION['logged_user']->login;?></a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="contact.php">Написать одмэну</a></li>
                <?php else: ?>
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Личный кабинет <?php echo $_SESSION['logged_user']->login; ini_set('display_errors','On');?></a>
                  <ul class="dropdown-menu">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Футболки Барселоны</h2>
                <div class="module-subtitle font-serif">Новая футболка Барселоны уже в продаже</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="module-small">
          <div class="container">
            <div class="row multi-columns-row">
              <div><h1 class="module-title font-alt">Шок Контент</h1></div>
                  <div id="goods"></div>
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <p><a href="contact2.php">Подробнее</a></li>
                </div>
              </div>
              <div class="col-sm-3">
                <div class="widget">
